...
bash deep-hc.sh 
```
To change the FCHC plug-in module, you can pick one of those in `model/hc_model.py` and afterward type the chosen one at *line 219* in `deep-hierarchy/hc_main.py`.
