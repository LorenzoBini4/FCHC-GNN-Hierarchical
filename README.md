...
This repository contains the official implementation of our paper titled "[Injecting Hierarchical Biological Priors into Graph Neural Networks for Flow Cytometry Prediction](https://openreview.net/forum?id=HJ5ILdCHFx)" published at the ICML 2024 Workshop on [Accessible and Efficient Foundation Models for Biological Discovery](https://accml.bio/).
